...
use crate::bindings::pkcs11t::*;

/// `C_Initialize` initializes the Cryptoki library.
///
/// # Parameters
///
/// * `pInitArgs`: if this is not NULL_PTR, it gets cast to
///   CK_C_INITIALIZE_ARGS_PTR and dereferenced
///
pub type C_Initialize = extern "C" fn(
...
///
pub type C_Finalize = extern "C" fn(
...
///
pub type C_GetInfo = extern "C" fn(
    pInfo: CK_INFO_PTR
) -> CK_RV;
...
///
pub type C_GetFunctionList = extern "C" fn(
...
///
pub type C_GetSlotInfo = extern "C" fn(
    slotID: CK_SLOT_ID,
...
///
pub type C_GetTokenInfo = extern "C" fn(
    slotID: CK_SLOT_ID,
...
/// * `ulPinLen`: length in bytes of the PIN
///
pub type C_InitPIN = extern "C" fn(
...
/// * `hSession`: the session's handle
///
pub type C_CloseSession = extern "C" fn(
    hSession: CK_SESSION_HANDLE
) -> CK_RV;
...
///
pub type C_CloseAllSessions = extern "C" fn(
    slotID: CK_SLOT_ID
) -> CK_RV;
...
///
pub type C_GetSessionInfo = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
...
/// * `hObject`: the object's handle
///
pub type C_DestroyObject = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
    hObject: CK_OBJECT_HANDLE
) -> CK_RV;
...
/// * `hSession`: the session's handle
///
pub type C_FindObjectsFinal = extern "C" fn(
    hSession: CK_SESSION_HANDLE
) -> CK_RV;
...
///
pub type C_DigestInit = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
    pMechanism: CK_MECHANISM_PTR
) -> CK_RV;
...
///
pub type C_DigestUpdate = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
    pPart: CK_BYTE_PTR,
    ulPartLen: CK_ULONG,
) -> CK_RV;
...
pub type C_DigestKey = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
    hKey: CK_OBJECT_HANDLE
) -> CK_RV;
...
///
pub type C_SignUpdate = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
    pPart: CK_BYTE_PTR,
    ulPartLen: CK_ULONG,
) -> CK_RV;
...
/// `C_SignRecover` signs data in a single operation, where the data
/// can be recovered from the signature.
///
/// # Parameters
///
...
/// `C_VerifyInit` initializes a verification operation, where the signature
/// is an appendix to the data, and plaintext cannot cannot be recovered from
...
/// the signature is an appendix to the data, and plaintext cannot be recovered
/// from the signature.
///
/// # Parameters
///
...
///
pub type C_VerifyUpdate = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
    pPart: CK_BYTE_PTR,
    ulPartLen: CK_ULONG,
) -> CK_RV;
...
///
pub type C_SeedRandom = extern "C" fn(
    hSession: CK_SESSION_HANDLE,
    pSeed: CK_BYTE_PTR,
    ulSeedLen: CK_ULONG,
) -> CK_RV;
...
/// * `hSession`: the session's handle
///
pub type C_GetFunctionStatus = extern "C" fn(
    hSession: CK_SESSION_HANDLE
) -> CK_RV;
...
/// * `hSession`: the session's handle
///
pub type C_CancelFunction = extern "C" fn(
    hSession: CK_SESSION_HANDLE
) -> CK_RV;
...
///
pub type C_WaitForSlotEvent = extern "C" fn(
    flags: CK_FLAGS,
